...
const HeroBanner: React.FC<HeroBannerProps> = ({ movie }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 p-4 sm:p-6 md:p-8 lg:p-12 text-netflix-white z-10 max-w-2xl">
        ...
        <ReactRouterDOM.Link 
          to={`/movie/${movie.id}`}
          className="inline-block bg-netflix-red hover:bg-netflix-red-hover text-netflix-white font-bold py-2 px-4 sm:py-3 sm:px-6 md:px-8 rounded text-sm sm:text-base md:text-lg transition-all transform hover:scale-105 shadow-lg"
        >
          View Details
        </ReactRouterDOM.Link>
      </div>
