...
const PersonDetail: React.FC = () => {
  ...
  if (!person) return <div className="text-center text-gray-400 text-xl mt-10">Person not found.</div>;
    ...
    <div className="space-y-12">
      <div className="md:flex md:space-x-8">
        ...
        <div className="md:w-2/3 mt-6 md:mt-0 text-white">
          <h1 className="text-4xl md:text-5xl font-black">{person.name}</h1>
          ...
          <div className="mt-6">
            <h3 className="text-2xl font-semibold mb-2">Biography</h3>
            {bio ? (
              <div className="text-gray-300 leading-relaxed">
                ...
                <p className="text-gray-400">No biography available for {person.name}.</p>
            )}
          </div>
        </div>
      </div>
      ...
      <section>
        <h2 className="text-3xl font-bold mb-6 border-l-4 border-blue-500 pl-4">Filmography</h2>
        {movies.length > 0 ? (
          ...
          <p className="text-center text-gray-400 text-lg mt-10">No movies found for this person.</p>
        )}
      </section>
    </div>
  );
